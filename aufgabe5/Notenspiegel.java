...
/**
 * Notenspiegel liest die Namen von Fächern mit den zugehörigen Noten
...
public final class Notenspiegel {
    ...
    public static void main(String[] args) {
        ...
        System.err.printf(
            "Fächer mit Noten zwischen %d und %d eingeben "
            + "(Ende mit Strg-D):%n",
        ...
        /* TODO: (3) tabellarischen Notenspiegel
                     mit der Überschrift NOTENSPIEGEL ausgeben */
